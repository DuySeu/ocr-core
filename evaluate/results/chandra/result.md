...
| --- | --- |
| engine | `chandra` |
| output_dir | `/Users/duyseu/Workspace/Lab/ocr-core/output/low_quality_handwritten` |
...
| --- | --- | --- | --- | --- | --- | --- |
| tonghopdon | 0.0553 | 0.0500 | 0.1029 | 47178 | 0 | tonghopdon.md |
| **all documents pooled** | **0.0553** | **0.0500** | **0.1029** | **47178** | **0** | — |
